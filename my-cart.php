					...
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								...
								<input type="submit" name="submit" value="Remove from cart" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
						</div>
					</td>
				</tr>
...
</div><!-- /just another blank space -->			<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
